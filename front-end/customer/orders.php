...
.mobile-search-dropdown .search-thumb img{width:100%;height:100%;object-fit:cover;border-radius:10px}
    ...
    @media(max-width:768px){
      ...
      .seg-btn{min-width:120px;font-size:16px;padding:10px 16px}
      .order-row{flex-direction:column;gap:10px}
      .order-left{flex-direction:column;align-items:flex-start}
      .logo-box{width:80px;height:64px;font-size:16px}
